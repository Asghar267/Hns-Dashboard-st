...
def simulate():
    ...
    # The new total should include EVERYTHING from raw data that isn't hidden by HIDDEN_PRODUCTS
    hidden_categories = ['Unused'] # Let's see if 103 removed (Unmapped)
    ...
    print(f"\n===== RESULTS FOR BRANCHES {branches} (v103 PERMANENT) =====")
